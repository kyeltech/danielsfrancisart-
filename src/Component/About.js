                        ...
                        <div className="row ">
                              ...
                              <div className="col-lg-11 d-flex text-white">
                                  <p className="border mr-2 h-100">
                                    ...
                                    <p>Keeping it simple but striking with a minimalist approach
                                    </p>
                              </div>
                        </div>
          ...
          <div className="container">
                ...
                <div className="row text-center about-container">
                    ...
                    <img src={hair} alt="artist" />
                        ...
                        <div className="col-lg-6 justifying text-left">
                  <p className="text-left font-size-10">
                    ...
                    <div className="container">
                      <div className="row text-center">
                        ...
                        <CountUp start={0} end={10} delay={0}>
                              {({ countUpRef }) => (
                                <div>
                                  <span ref={countUpRef} className="font-weight-bold fs-2 fonting" />
                                  <span className="fonting">
                              +
                            </span>
                                  <div>
