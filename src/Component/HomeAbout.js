            ...
            <div className="col-lg-12 py-5">
              <div className="row">
                ...
                <div className="col-lg-6 text-center ">
                  <ContainerHeader className="mb-4">About Us</ContainerHeader>
                  <ContainerContent className="">
                    In layman's terms, Lorem Ipsum is a dummy or placeholder
                    text. It's often used in laying out print, infographics, or
                    web design. The primary purpose of Lorem Ipsum is to create
                    text that does not distract from the overall layout and
                    visual hierarchy Lorem ipsum dolor sit amet, consectetur
                  ...
                  <Btn className="mt-5"> Learn more </Btn>
                </div>
              </div>
            </div>
          </RowContainer>
                      ...
                      <div className="container-caption row">
                        <div className="col-lg-12 text-center  inner-values">
                          <ImgIcon
                            src={events.icons}
                            alt="printicon"
                            className="img-fluid inner-images mb-4 "
                          />
                          <h1
                            style={{
                              color: "white",
